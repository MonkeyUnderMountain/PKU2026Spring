...
\coversentence{\CJKfamily{lxgwwenkai} 問おう。あなたがわたしのマスターか？} % 封面语句
\coverimage{Saber_Artoria.jpg} % 封面图片
...
\begin{document}
    ...
    \input{March_09/text.tex}
    \input{March_11/text.tex}
