...
\title{Algebraic Cycles by Fumiaki Suzuki}
\author{Tianle Yang}
\date{\today}
...
\begin{document}
    ...
    \input{text.tex}
    \input{March_03/text.tex}
    \input{March_05/text.tex}
    \input{March_10/text.tex}
    \input{March_17/text.tex}
    \input{March_19/text.tex}
    \input{March_24/text.tex}
    \input{March_31/text.tex}
    \input{April_02/text.tex}
    \input{April_07/text.tex}
    \input{April_14/text.tex}
    \input{April_16/text.tex}
