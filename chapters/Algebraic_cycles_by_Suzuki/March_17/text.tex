...
\subsection{Vector bundles and projective bundles}
  ...
  \begin{remark}
    ...
    Its $\bbP(E)$ is the dual projective bundle of our $\bbP(\calE)$.
  \end{remark}
  ...
  \begin{theorem}\label{thm:Chow_group_of_vector_and_projective_bundle}
    ...
    \begin{enumerate}
      ...
      \item We have isomorphisms of abelian groups:
        \[\theta_E : \bigoplus_{j=0}^{r-1} \CH_{i-j}(X) \to \CH_i(\bbP(E)), \quad (a_0, \ldots, a_{r-1}) \mapsto \sum_{j=0}^{r-1} c_1(\calO_{\bbP(E)}(1))^j \cap p^*a_j. \]
  ...
  \begin{proof}[Proof of \cref{thm:Chow_group_of_vector_and_projective_bundle}]
    ...
    \[\begin{tikzcd}
        \CH_{i}(Z) \arrow[r]\arrow[d, "\cong"] & \CH_{i}(X) \arrow[r]\arrow[d, "\cong"] & \CH_{i}(U) \arrow[r]\arrow[d, "\cong"] & 0 \\
    ...
    \begin{step}
      Surjectivity of the map $\theta_E: \bigoplus_{j=0}^{r-1} \CH_{i-j}(X) \to \CH_i(\bbP(E))$.
    \end{step}
    ...
    We have a diagram:
    \[ \bbP(E) = X \times \bbP^{r-1} \injmap^f X \times \bbP \hookleftarrow^g E = X \times \bbA^r. \]
    This diagram induces
    \[\begin{tikzcd}
        \CH_{i}(\bbP(E)) \arrow[r, "\theta_E"]\arrow[d, "\id"] & \CH_i(\bbP(E)) \arrow[r, "f_*"]\arrow[d, "f^*"] & \CH_i(X \times \bbP) \arrow[d, "g^*"] \\
        \bigoplus_{j=0}^{r-1} \CH_{i-j}(X) \arrow[r, "\theta_E"] & \CH_i(\bbP(E)) \arrow[r, "f_*"] & \CH_i(X \times \bbP).
    \end{tikzcd}\]
    \Yang{}

    Let $\beta \in \CH_i(X \times \bbP)$.
    Since $\pi^*$ is surjective, there exists $\alpha \in \CH_{i-(r-1)}(X)$ such that $g^*\beta = p^*\alpha$.
    ...
    \[ f_*\theta_E((\alpha_j)) = \beta - q^*\alpha. \]

    Note that $\calO_{\bbP(E)}(1) = f^*\calO_{X \times \bbP}(1)$, we have
  ...
  \begin{proof}[Proof of the claim]
    May assume $\alpha = [V]$ and $X = V$ is a variety.
    Then $p_*(c_1(\calO_{\bbP(E)}(1))^j \cap p^*[X]) \in \CH $.
    For $j < r-1$, 
...
\subsection{Chern classes of vector bundles}
  ...
  \begin{definition}
    ...
    \[ s_j(E) \cap : \CH_i(X) \to \CH_{i-j}(X), \quad \alpha \mapsto c_1(\calO_{\bbP(E)}(1))^{r-1+j} \cap p^*\alpha. \]
  \end{definition}
  ...
  \begin{proposition}
    \begin{enumerate}
      ...
      \item Let $L$ be a line bundle on $X$, $\alpha \in \CH_i(X)$.
      Then $s_1(L) \cap \alpha = -c_1(L) \cap \alpha$.
    \end{enumerate}
  \end{proposition}
  \begin{proof}
    (a) - (d) follow from the corresponding statements for $c_1(L) \cap$ for line bundles $L$ on $X$.
    For instance, as for (c), we have a commutative diagram:
    \[\begin{tikzcd}
