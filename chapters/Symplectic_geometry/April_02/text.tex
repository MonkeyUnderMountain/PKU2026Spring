...
\subsection{Symplectic group actions}
  ...
  \begin{lemma}
    ...
    If there exists a linear map $\tilde{\mu}: \frakg \to C^\infty(M)$ such that \eqref{eq:commutative_diagram_for_symplectic_group_actions} commutes, then $\tilde{\mu}$ is a comoment map.
  \end{lemma}
  \begin{proof}
