...
\title{Class field theory by Junyi Xie}
\author{Tianle Yang}
\date{\today}
...
\coverimage{FSF_False_Assassin.png} % 封面图片
...
\begin{document}
    ...
    \input{March_02/text.tex}
    \input{March_06/text.tex}
    \input{March_13/text.tex}
    \input{March_16/text.tex}
    \input{March_20/text.tex}
    \input{March_27/text.tex}
    \input{March_30/text.tex}
    \input{April_03/text.tex}
    \input{April_10/text.tex}
